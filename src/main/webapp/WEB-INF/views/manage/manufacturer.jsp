...
<body>
    <main>
        ...
        <div class="manufacturer_popup_wrap popup_wrap" style="display: none;">
            <div class="manufacturer_popup popup">
                <h2>제조사 <span>추가</span></h2>
                <input type="text" id="mfi_name" placeholder="제조사 이름">
                <input type="text" id="mfi_phone" placeholder="제조사 전화번호">
                <input type="text" id="mfi_email" placeholder="제조사 메일 주소">
                <div class="buttons">
